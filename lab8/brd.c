...
struct brd_device {
    ...
    struct request_queue    *brd_queue;   // include/linux/blkdev.h
            ...
            unsigned int cmd, unsigned long arg)
{
    ...
    /* Enter brd_ioctl, print hello message */
    printk(KERN_INFO "Enter brd_ioctl, [cmd]:%-5u, [arg]:%-5lu\n",
        cmd, arg);

    /* set flag to enable snapshot */
    switch(arg) {
        case 0: break;
    ...
    printk(KERN_INFO "enable_snapshot:%-5d\n", enable_snapshot);
